...
$amount_online = get_post_meta($order->get_id(), "amount_online")[0];
...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	...
	<tfoot>
	<?php if( ! empty( $amount_online )) : ?>
	<tr>
		<th class="td" scope="row" colspan="2" style="text-align:<?php echo $text_align; ?>; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?>"><?php _e( 'Paypal:', 'ktdizajn' ); ?></th>
		<td class="td" style="text-align:<?php echo $text_align; ?>; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?>"><?php echo get_woocommerce_currency_symbol().$amount_online; ?></td>
	</tr>
	<tr>
		<th class="td" scope="row" colspan="2" style="text-align:<?php echo $text_align; ?>; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?>"><?php _e( 'Cash:', 'ktdizajn' ); ?></th>
		<td class="td" style="text-align:<?php echo $text_align; ?>; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?>"><?php echo get_woocommerce_currency_symbol().$cash; ?></td>
	</tr>
	<?php endif; ?>
		<?php
